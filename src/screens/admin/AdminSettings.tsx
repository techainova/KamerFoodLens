  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFAF5' }}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        ...
        {/* Danger banner */}
        {maintenanceMode && (
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, padding: 12, borderRadius: 14, backgroundColor: '#FBDCDC', borderWidth: 1, borderColor: '#C6282840', marginBottom: 16 }}>
        ...
        {/* Access */}
        <Text style={{ fontSize: 11, fontWeight: '600', color: '#8C8278', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 8 }}>Accès & Disponibilité</Text>
        <View style={{ borderRadius: 18, backgroundColor: '#fff', borderWidth: 1, borderColor: '#E5E0D8', overflow: 'hidden', marginBottom: 16 }}>
          {toggleItems.map((item, i) => (
            <View key={i} style={{ flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16, paddingVertical: 14, borderBottomWidth: i < 2 ? 1 : 0, borderColor: '#F5F0EB' }}>
        ...
        {/* Finance */}
        <Text style={{ fontSize: 11, fontWeight: '600', color: '#8C8278', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 8 }}>Finance</Text>
        <View style={{ borderRadius: 18, backgroundColor: '#fff', borderWidth: 1, borderColor: '#E5E0D8', padding: 16, marginBottom: 16 }}>
          <Text style={{ fontSize: 14, color: '#2C1810', marginBottom: 8 }}>Commission KFL (%) sur commandes</Text>
          <View style={{ height: 48, borderWidth: 1, borderColor: '#E5E0D8', borderRadius: 14, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            <Icon name="Percent" size={16} color="#8C8278" />
            <TextInput
              value={commission} onChangeText={setCommission}
              keyboardType="numeric" style={{ flex: 1, fontSize: 14, color: '#2C1810' }}
            />
        ...
        {/* App info */}
        <Text style={{ fontSize: 11, fontWeight: '600', color: '#8C8278', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 8 }}>Infos app</Text>
        <View style={{ borderRadius: 18, backgroundColor: '#fff', borderWidth: 1, borderColor: '#E5E0D8', overflow: 'hidden' }}>
          {[
            ...
            <View key={i} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: i < 2 ? 1 : 0, borderColor: '#F5F0EB' }}>
              <Text style={{ fontSize: 14, color: '#8C8278' }}>{row.l}</Text>
              <Text style={{ fontSize: 13, color: '#2C1810', fontFamily: 'JetBrainsMono-Regular' }}>{row.v}</Text>
            </View>
          ))}
        </View>
      </ScrollView>
