  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: C.cream }}>
      ...
      <View style={{ height: 56, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: C.surface, borderBottomWidth: 1, borderColor: C.border }}>
        ...
        <Text style={{ flex: 1, fontFamily: 'PlayfairDisplay-Bold', fontSize: 20, color: C.ink }}>Tombola</Text>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ margin: 16, borderRadius: 20, backgroundColor: '#F9A825', padding: 20, ...SHADOW_MD }}>
          ...
          <Text style={{ fontSize: 22, fontFamily: 'PlayfairDisplay-Bold', color: C.ink, marginBottom: 16 }}>30 Juin 2024 à 20h00</Text>
        ...
        <View style={{ paddingHorizontal: 16, marginBottom: 20 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 12 }}>
            <Text style={{ flex: 1, fontSize: 16, fontFamily: 'PlayfairDisplay-Bold', color: C.ink }}>Mes billets ({MY_TICKETS.length})</Text>
          </View>
              ...
              >
                {ticket.lucky && (
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 8 }}>
                    ...
                    <Text style={{ fontSize: 9, fontWeight: '700', color: C.ink, textTransform: 'uppercase' }}>Chanceux</Text>
                  </View>
                )}
        ...
        {/* Prizes */}
        <View style={{ paddingHorizontal: 16, marginBottom: 20 }}>
          <Text style={{ fontSize: 16, fontFamily: 'PlayfairDisplay-Bold', color: C.ink, marginBottom: 12 }}>Lots à gagner</Text>
          <View style={{ gap: 10 }}>
            {PRIZES.map((prize, i) => (
              <View key={i} style={{ backgroundColor: C.surface, borderRadius: 16, padding: 14, flexDirection: 'row', alignItems: 'center', gap: 12, borderWidth: 1, borderColor: C.border, ...SHADOW_SM }}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: 13, fontWeight: '600', color: C.ink, marginBottom: 1 }}>{prize.prize}</Text>
                  <Text style={{ fontSize: 11, color: C.inkMute }}>Valeur : {prize.value}</Text>
                </View>
              </View>
            ))}
          </View>
      ...
      <View style={{ position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: C.surface, borderTopWidth: 1, borderColor: C.border, padding: 16 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 12 }}>
          <Text style={{ flex: 1, fontSize: 14, color: C.inkSoft }}>Quantité de billets</Text>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('MobileMoneyConfirm', { provider: 'mtn', amount: total, phone: '+237 6XX XXX XXX' })}
