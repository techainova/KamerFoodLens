    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: C.cream }}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
            ...
            {DISHES.map((d, i) => (
              <TouchableOpacity key={i} style={{ alignItems: 'center', gap: 6 }} activeOpacity={0.75}>
                <View style={{ width: 66, height: 66, borderRadius: 33, padding: 2.5, borderWidth: 2, borderColor: i === 0 ? '#E8591A' : '#E5E0D8' }}>
                  <View style={{ flex: 1, borderRadius: 28, backgroundColor: C.surface2 }} />
                </View>
                <Text style={{ fontSize: 10.5, fontWeight: '500', color: C.inkSoft, maxWidth: 64, textAlign: 'center' }}>{d.name}</Text>
              </TouchableOpacity>
            ))}
          </ScrollView>
        </View>
        ...
        <View style={{ marginTop: 18, paddingHorizontal: 16 }}>
          ...
          <TouchableOpacity style={{ backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 16, overflow: 'hidden' }} activeOpacity={0.85}>
            ...
            <View style={{ padding: 14 }}>
              <Text style={{ color: C.ink, fontSize: 14, fontWeight: '700', fontFamily: 'Inter-Bold' }}>Festival du Ndolé · Douala</Text>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 }}>
                <Icon name="MapPin" size={11} color="#8C8278" />
                <Text style={{ color: C.inkMute, fontSize: 11 }}>Bonanjo, Douala · 14h–22h</Text>
              </View>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                  <Icon name="Users" size={12} color="#8C8278" />
                  <Text style={{ color: C.inkMute, fontSize: 11 }}>248 inscrits</Text>
                </View>
