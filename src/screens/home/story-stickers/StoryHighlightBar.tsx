...
export default function StoryHighlightBar({ highlights, isMine, myAuthorId, onOpenHighlight }: Props) {
  ...
  return (
    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ flexGrow: 0 }} contentContainerStyle={{ paddingHorizontal: 16, gap: 16, paddingVertical: 4, alignItems: 'center' }}>
      {isMine && (
