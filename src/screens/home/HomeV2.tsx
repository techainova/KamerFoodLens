...
export default function HomeV2() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: C.cream }}>
      {/* Header */}
      <View style={{ paddingHorizontal: 20, paddingTop: 14, paddingBottom: 14, backgroundColor: C.surface, borderBottomWidth: 1, borderColor: C.border }}>
        ...
        >
          ...
          <Text style={{ flex: 1, color: C.inkMute, fontSize: 13, fontFamily: 'Inter-Regular' }}>{t('home.searchPlaceholder', 'Plat, restaurant, région...')}</Text>
        ...
        <View style={{ padding: 16 }}>
          <View style={{ flexDirection: 'row', gap: 10 }}>
            ...
            <View style={{ flex: 1, gap: 10 }}>
              <TouchableOpacity
                style={{ flex: 1, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 18, padding: 14, justifyContent: 'space-between' }}
                activeOpacity={0.8}
                onPress={() => nav.navigate('RecipeV1')}
              >
                <View style={{ width: 36, height: 36, borderRadius: 10, backgroundColor: C.errorSoft, alignItems: 'center', justifyContent: 'center' }}>
                  <Icon name="ChefHat" size={18} color="#E8591A" />
                </View>
                <Text style={{ color: C.ink, fontSize: 13, fontWeight: '700', fontFamily: 'Inter-Bold' }}>{t('recipe.title')}</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={{ flex: 1, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 18, padding: 14, justifyContent: 'space-between' }}
                activeOpacity={0.8}
              ...
              >
                ...
                <Text style={{ color: C.ink, fontSize: 13, fontWeight: '700', fontFamily: 'Inter-Bold' }}>{t('map.title')}</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={{ flexDirection: 'row', gap: 10, marginTop: 10 }}>
            <TouchableOpacity
              style={{ flex: 1, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 14, padding: 12, minHeight: 78, justifyContent: 'space-between' }}
              activeOpacity={0.8}
              onPress={() => nav.navigate('Events')}
            >
              <View style={{ width: 32, height: 32, borderRadius: 8, backgroundColor: C.navySoft, alignItems: 'center', justifyContent: 'center' }}>
                <Icon name="Calendar" size={16} color="#1A237E" />
              </View>
              <Text style={{ color: C.ink, fontSize: 11, fontWeight: '700', fontFamily: 'Inter-Bold' }}>{t('events.title')}</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{ flex: 1, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 14, padding: 12, minHeight: 78, justifyContent: 'space-between' }}
              activeOpacity={0.8}
            ...
            >
              <View style={{ width: 32, height: 32, borderRadius: 8, backgroundColor: C.successSoft, alignItems: 'center', justifyContent: 'center' }}>
                <Icon name="Globe" size={16} color="#2E7D32" />
              </View>
              <Text style={{ color: C.ink, fontSize: 11, fontWeight: '700', fontFamily: 'Inter-Bold' }}>Forum</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{ flex: 1, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 14, padding: 12, minHeight: 78, justifyContent: 'space-between' }}
              activeOpacity={0.8}
            ...
            >
              <View style={{ width: 32, height: 32, borderRadius: 8, backgroundColor: C.goldSoft, alignItems: 'center', justifyContent: 'center' }}>
                <Icon name="Trophy" size={16} color="#F9A825" />
              </View>
              <Text style={{ color: C.ink, fontSize: 11, fontWeight: '700', fontFamily: 'Inter-Bold' }}>{t('games.title')}</Text>
            </TouchableOpacity>
          </View>
        </View>
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 2 }}>
                    ...
                    <Text style={{ color: C.inkMute, fontSize: 11 }}>+{item.scans} scans</Text>
                    <Text style={{ color: '#E5E0D8' }}> · </Text>
                    <Icon name="MapPin" size={11} color="#8C8278" />
                    <Text style={{ color: C.inkMute, fontSize: 11 }}>{item.region}</Text>
                  </View>
                </View>
